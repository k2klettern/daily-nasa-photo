...
{
    public const NASA_TRANSIENT_NAME = "nasa-picture-data";
    private const OPTION_NASA_FIELD = "nasa-api-token";
    private const QUARTER_OF_A_DAY_IN_SECONDS = 21600;
    protected $token;
    protected $url;
    ...
    public function formSubmitProcessing()
    {
        ...
        echo " />";
        echo "<p>Visit <a href='https://api.nasa.gov' target='_blank'>
		https://api.nasa.gov</a> to get a free Api Key Token</p>";
    }
